...
const Sidebar: React.FC<SidebarProps> = ({ isSidebarCollapsed, isMobileMenuOpen, setIsMobileMenuOpen }) => {
    ...
    const navItems: NavItem[] = [
        { name: 'Dashboard', icon: 'dashboard', path: '/dashboard' },
        {
            ...
            children: [
                ...
                { name: 'Assessments', path: '/courses/assessments' },
                { name: 'Assessment Deadlines', path: '/courses/assessment-deadlines' },
            ]
        },
        {
    ...
    return (
        <>
            ...
            >
                {/* Logo Section */}
                <div className={`flex-shrink-0 flex flex-col items-center justify-center border-b border-gray-100 dark:border-gray-700 transition-all duration-300 ${isSidebarCollapsed ? 'h-[72px] py-2' : 'h-32 pt-2 pb-4'}`}>
                    <div
